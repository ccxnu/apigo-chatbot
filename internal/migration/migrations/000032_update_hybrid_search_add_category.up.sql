-- Update fn_similarity_search_chunks_hybrid to add category parameter

DROP FUNCTION IF EXISTS fn_similarity_search_chunks_hybrid(vector, text, int, float, float);
