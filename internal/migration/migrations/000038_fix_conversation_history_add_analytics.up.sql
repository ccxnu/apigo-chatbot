-- =====================================================
-- Migration 000038: Fix fn_get_conversation_history to include analytics columns
-- =====================================================
-- Add cvm_queue_time_ms and other analytics columns added in migration 000024
...
RETURNS TABLE (
    ...
    cvm_metadata JSONB,
    cvm_queue_time_ms INT,
    cvm_prompt_tokens INT,
    cvm_prompt_time_ms INT,
    cvm_completion_tokens INT,
    cvm_completion_time_ms INT,
    cvm_total_tokens INT,
    cvm_total_time_ms INT,
...
BEGIN
    ...
    SELECT
        ...
        m.cvm_queue_time_ms,
        m.cvm_prompt_tokens,
        m.cvm_prompt_time_ms,
        m.cvm_completion_tokens,
        m.cvm_completion_time_ms,
        m.cvm_total_tokens,
        m.cvm_total_time_ms,
        m.cvm_created_at
...
COMMENT ON FUNCTION fn_get_conversation_history IS 'Get message history for a conversation including sender type and analytics data';
